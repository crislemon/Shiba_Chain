...
def Nambu(spectro_up, spectro_down, spectro_uphole, spectro_downhole, vv, row, borde):
    ...
    np.savetxt('spectro_nambu1.txt', spectro_up_1)
    np.savetxt('spectro_nambu2.txt', spectro_down_1)
    np.savetxt('spectro_nambu3.txt', spectro_uphole_1)
    np.savetxt('spectro_nambu4.txt', spectro_downhole_1)